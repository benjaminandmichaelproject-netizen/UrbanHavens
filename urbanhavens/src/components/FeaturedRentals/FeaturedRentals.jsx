...
import { api, refreshAccessToken, clearAuthStorage } from "../../Dashboard/Owner/UploadDetails/api/api";
        ...
        {image ? (
          ...
          <div className="rental-card-image-placeholder">
            <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#fff">
              <path d="M3 9.5L12 3l9 6.5V20a1 1 0 01-1 1H4a1 1 0 01-1-1V9.5z" strokeWidth="1.5" />
